...
namespace Emi.UserControls
{
    ...
    public partial class CloseableTabItem
    {
        ...
        /// <remarks>If the value is set to true then the header is a <see cref="CloseableHeader"/> containing the <see cref="title"/> and a close button. If the value is set to false the header is the <see cref="title"/>.</remarks>
