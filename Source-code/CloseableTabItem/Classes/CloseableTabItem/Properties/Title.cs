...
namespace Emi.UserControls
{
    ...
    public partial class CloseableTabItem
    {
        ...
        /// <remarks>If <see cref="isCloseable"/> is set to false then the header of the tab item is updated with the title. In any case the <see cref="closeableHeader"/> field is updated with the title in case the <see cref="IsCloseable"/> property is changed.</remarks>
