...
// <copyright company="eMedia Intellect℠" file="GeneratePath.cs">
...
namespace Emi.UserControls
{
    ...
    /// <content>Contains the <see cref="GeneratePath"/> method.</content>
    public partial class FileSystemBrowserWindow
    {
        /// <summary>Generates the path as instances of the <see cref="PathButton"/> class.</summary>
