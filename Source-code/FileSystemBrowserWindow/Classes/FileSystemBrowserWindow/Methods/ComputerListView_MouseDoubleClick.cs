...
// <copyright company="eMedia Intellect" file="ComputerListView_MouseDoubleClick.cs">
...
namespace Emi.UserControls
{
    ...
    /// <content>Contains the <see cref="ComputerListView_MouseDoubleClick"/> method.</content>
    public partial class FileSystemBrowserWindow
    {
        /// <summary>Browses to the drive when the button is double-clicked.</summary>
        ...
        private void ComputerListView_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
